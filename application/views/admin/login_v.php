...
<div class="login-container lightmode">
    <div class="login-box animated fadeInDown">
        ...
        <div class="login-body">
            <div class="login-title"><strong>Log In</strong> to Resto</div>
            <?php
            ...
            <br><center><p style="color: white;">Created by <a style="color: red;" href='https://kelompok8.com/' title='kelompok8.com' target='_blank'>kelompok8</a></p></center>
